...
export function HomeScreen({ navigate, proposals }: HomeScreenProps) {
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="flex-1 overflow-y-auto pb-16">
        ...
        <div className="px-6 pb-6">
          <h2 className="text-gray-900 mb-4">Ongoing Shared Purchases</h2>
          
          <div className="space-y-4">
            {proposals.length === 0 ? (
              <p className="text-gray-500 text-sm">No shared purchases yet. Be the first to create one!</p>
            ) : (
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1 text-gray-600 mb-2">
                        ...
                        <span className="text-sm">
                          {proposal.participants} of {proposal.maxParticipants} joined
                        </span>
                      </div>
